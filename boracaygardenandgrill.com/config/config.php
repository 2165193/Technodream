<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Boracay Garden and Grill.", 
			"phone" =>  "(650)871-8644", 
			"phone2" =>  "650-871-8623", 		  //either no format or dashed format
			"email" => "boracaygarden@att.net",   //by default is used as recipient email  
			"address" => "269 El Camino Real South San Francisco, CA 94083", 
