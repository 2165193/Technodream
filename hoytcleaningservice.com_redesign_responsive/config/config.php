<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Hoyt Cleaning Service", 
			"phone" =>  "470-422-6631", 		  //either no format or dashed format
			"email" => "hoytcleaning@gmail.com",   //by default is used as recipient email  
			"address" => "100 Post Master Drive unit 2461 McDonough, GA 30253", 
