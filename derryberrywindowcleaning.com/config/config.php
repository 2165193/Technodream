<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Derry Berry’s Luxury Cleaning Services", 
			"phone" =>  "530.923.8590", 		  //either no format or dashed format
			"email" => "metalman1968.jdd@gmail.com",   //by default is used as recipient email  
			"address" => "Put Address Here, Put Address Here,1234", 
