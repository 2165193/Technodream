<footer>
	<div id="footer">
		<div class="ftTop">
			<div class="row">
				<h2>CONTACT US</h2>
				<p>I will be glad to answer your questions, feel free to ask a piece of information or a quotation.</p>
				<p>I‘m looking forward to work with you.</p>
				<a href="home"><img src="public/images/common/ftLogo.jpg" alt="samp"></a>
				<div class="ftInfo">
					<p class="ftEmail inb">
						<img src="public/images/common/emailIcon.png" alt="">
						<span>EMAIL</span>
					...
					<p class="ftEmail inb">
						<img src="public/images/common/locationIcon.png" alt="samp">
						<span>LOCATION</span>
		...
		<div class="ftBot">
			<div class="row">
				<div class="navBar">
					<div class="ftBotLeft fl">
						<nav>
							...
							<li <?php $this->helpers->isActiveMenu("testimonials"); ?>><a href="<?php echo URL ?>testimonial#content">TESTIMONIALS</a></li>
				...
				<div class="copyright">
					<p class="copy">
						Cooyright © <?php echo date("Y"); ?>. <?php $this->info("company_name"); ?> All Rights Reserved. 
