	...
	<div id="footer">
		<div class="row">
			...
			<div class="rightCont">
				...
				<p><img src="public/images/common/marker-white.png" alt="Location"><span><?php $this->info("address");?></span></p>
				<p><img src="public/images/common/mail-white.png" alt="E-Mail"><span><?php $this->info(["email","mailto"]);?></span></p>
				<p class="socialMed">
					<span>FOLLOW US:</span>
