<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "EXCELLENT GARAGE DOORS", 
			"phone" =>  "847-504-6155", 		  //either no format or dashed format
			"email" => "excellentgaragedoor@gmail.com",   //by default is used as recipient email  
