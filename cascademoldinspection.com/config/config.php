<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Cascade Mold Inspection LLC", 
			"phone" =>  "(360)399-6204", 		  //either no format or dashed format
			"email" => "luke@cascademoldinspection.com",   //by default is used as recipient email   
			"address" => "Serving Skagit Island, Whatcom, & Snohomish Counties", 
