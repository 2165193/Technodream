<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "QUINTANA’S RV & BOAT STORAGE CENTER ", 
			"phone" =>  "(904)674-1335", 		  //either no format or dashed format
			"email" => "ARICHDESIGN@NETZERO.NET",   //by default is used as recipient email  
			"address" => "465 Roberts St Jacksonville, FL 32254", 
