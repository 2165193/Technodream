<?php
	...
	$siteInfo= [
			...
			"phone" =>  "248-268-2135", 		  //either no format or dashed format
			"email" => "support@completecarephysicaltherapy.com",   //by default is used as recipient email  
			"address" => "23350 Greenfield Rd Suite# 101A, Oak Park, MI, 48237", 
