<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "MOMO HARDWOOD FLOOR. ", 
			"phone" =>  "(413)281-0182", 		  //either no format or dashed format
			"email" => "momohardwoodfl@hotmail.com",   //by default is used as recipient email  
