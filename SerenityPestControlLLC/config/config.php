<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Serenity Pest Control LLC ", 
			"phone" =>  "817-627-7404",
			"phone2" =>  "(631)698-0484 ",		  //either no format or dashed format
			"email" => "serenitypestcontrolllc@gmail.com",   //by default is used as recipient email  
			"address" => "20 Jane Street Selden, NY 11784", 
