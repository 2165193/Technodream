<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "MAIKA’I CONSTRUCTION", 
			"phone" =>  "(808)258-1808", 		  //either no format or dashed format
			"email" => "maikaiconstruction808 <span>@gmail.com</span>",   //by default is used as recipient email  
