<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Aqua Techs Pools & Spas LLC.", 
			"phone" =>  "505-850-3764", 		  //either no format or dashed format
			"email1" => "abqaquaman@hotmail.com",
			"email2" => "aquatechsreceptiondesk@hotmail.com",   //by default is used as recipient email  
			"address" => "7009 Red Sky Ct NE Albuquerque, New Mexico", 
