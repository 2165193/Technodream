...
/*	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	...
	$wp_customize->add_control( 'address', array(
		'label'		=> __( 'Location Address', 'scwd' ),
		'section'	=> 'general_section',
		'settings'	=> 'address',
		'priority'	=> 20,
	) );
	...
	$wp_customize->add_control( 'email', array(
		'label'		=> __( 'Email Address1', 'scwd' ),
		'section'	=> 'general_section',
		'settings'	=> 'email',
		'priority'	=> 30,
	) );
	// email address2
	$wp_customize->add_setting( 'email2', array(
		'default' => null,
		'sanitize_callback' => 'scwd_sanitize_text'
	) );
	$wp_customize->add_control( 'email2', array(
		'label'		=> __( 'Email Address2', 'scwd' ),
		'section'	=> 'general_section',
		'settings'	=> 'email2',
		'priority'	=> 40,
	) );
