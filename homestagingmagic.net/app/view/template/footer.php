	...
	<div id="footerTop">
		<div class="row">
			<div class="cols col-1">
				<dl>
					<dt><img src="public/images/common/phone.png" alt=""></dt>
					<dd>
						<p>CALL US TODAY<span><?php $this->info(["phone","tel"]);?></span></p>
					</dd>
				</dl>
				<dl>
					<dt><img src="public/images/common/mail.png" alt=""></dt>
					<dd>
						<p>SEND US MESSAGE<span><?php $this->info(["email","mailto"]);?></span></p>
					</dd>
				</dl>
			</div>
			...
			<div class="cols col-2">
				<dl>
					<dt><img src="public/images/common/loc.png" alt=""></dt>
					<dd>
						<p>Home Staging Magic<span><?php $this->info("address");?></span></p>
					</dd>
				</dl>
				<p class="socialMedia">
