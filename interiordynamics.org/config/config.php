<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "INTERIOR DYNAMICS", 
			"phone" =>  "719-591-7115", 		  //either no format or dashed format
			"email" => "interiordynamics@aol.com",   //by default is used as recipient email  
