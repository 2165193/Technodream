<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Morgan Home Inspection, LLC", 
			"phone" =>  "(985)278-9472", 		  //either no format or dashed format
			"email" => "jlmorg@yahoo.com",   //by default is used as recipient email  
			"address" => "Serving Raceland LA 70394 surrounding area", 
