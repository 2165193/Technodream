<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Reliable Towing and Recovery", 
			"phone" =>  "(915)892-4633", 		  //either no format or dashed format
			"email" => "Reliabletowingsvc@aol.com",   //by default is used as recipient email  
			"address" => "809 Wadsworth Rd. Canutillo, Texas 79835", 
