...
<?php $this->checkSuspensionHeader(); ?>
	<header>
		<div id="header">
			<div class="row">
				...
				<div class="contact">
					CALL US TODAY<span><?php $this->info(["phone","tel"]);?></span>
				</div>
			</div>		
		</div>
	</header>
	<div id="banner">
		<div class="row">
			...
			<h2>WE LET OUR QUALITY WORK TO  CUSTOMER SATISFACTION</h2>
			<a href="contact#content" class="req">Get A Free Quote</a>
		</div>
	</div>