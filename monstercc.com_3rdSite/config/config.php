<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Monster Commercial Contractors", 
			"phone" =>  "915-383-0188", 		  //either no format or dashed format
			"email" => "contractors.monster@gmail.com",   //by default is used as recipient email  
			"address" => "14433 Eichelberger Avenue El Paso, TX 79938", 
