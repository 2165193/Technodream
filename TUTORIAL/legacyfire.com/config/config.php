<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "LEGACY FIRE SERVICE",
			"phone" =>  "775-432-2336",
			"fax" => "775-800-1565", 		  //either no format or dashed format
			"email" => "billy@legacyfire.com",
			"email2" => "mike@legacyfire.com",   //by default is used as recipient email
			"address" => "1380 Greg Street, Suite <br/> 220 Sparks, NV 89431",
			...
			//pivate policy link
			"policy_link" => 'privacy_policy#content', //change the value to privacy-policy for Privacy Policy Page
