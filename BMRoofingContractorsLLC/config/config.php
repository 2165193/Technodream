<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "BM Roofing Contractors LLC", 
			"phone" =>  "(937)510-0606", 		  //either no format or dashed format
			"email" => "hmgenesis88@gmail.com",   //by default is used as recipient email  
